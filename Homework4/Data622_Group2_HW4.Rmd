...
df.svm=svm(Suicide~Abuse+Education+ADHD.Q1+Alcohol+ADHD.Q16+ADHD.Total+ADHD.Q18+ADHD.Total+ADHD.Q9+ADHD.Q2,data=df_train, kernel="radial")
summary(df.svm)
```
