...
We can use kNN imputation to help replace many of the missing values. With the KNN method, a categorical missing value is imputed by looking at other records with similar features. Once k similar records are found, they are used to infer the missing value. 
...
[TODO: Zach note, I'm not very sure how to interpret this given the large number of variables here. If someone wants to take a look at it and provide some context that's great. However, this section may be good with our current visualizations and insight.]
