...
```{r}
forest.cm_train2 <- confusionMatrix(forest.pred2, test_loan$Loan_Status)
forest.cm_train2
```
...
set.seed(1)
boost<-gbm(Loan_Status~., data=train_loan[,-1],distribution = "gaussian",n.trees = 5000,cv.folds = 5)
```
...
```{r}
boostPre<-predict(boost,test_loan,n.trees =27)
