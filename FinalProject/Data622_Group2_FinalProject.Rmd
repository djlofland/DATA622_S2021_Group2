...
```
From our model ouput above, we can see that the accuracy is lower than some of our other model approaches at 78%. Additionally, the sensitivity and specificity are also lower at 70% and 85% respectively. Because of this, we can determine that other techniques may be more effective classifiers.
...
[TODO: Discuss feature importance across 5 models. Note from Zach: I added a bit above, but not sure if others have additional things to add.]
